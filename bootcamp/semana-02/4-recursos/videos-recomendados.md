# 🎬 Videos Recomendados - Semana 02

## Triggers y Debugging en n8n

![Videos](https://img.shields.io/badge/Tipo-Videos-FF6D5A?style=flat-square)
![Tiempo](https://img.shields.io/badge/Tiempo_Total-~2_horas-00D4FF?style=flat-square)
...
## 📝 Cómo Aprovechar los Videos

### Antes de Ver

1. Ten n8n abierto y listo para practicar
2. Lee primero la teoría del módulo correspondiente
3. Prepara preguntas específicas

### Durante el Video

1. Pausa y replica lo que ves
2. Toma notas de conceptos nuevos
3. Identifica diferencias con tu versión de n8n

### Después del Video

1. Intenta recrear sin ver el video
...
Si no encuentras los videos específicos, usa estas búsquedas:

```
n8n trigger types tutorial
n8n webhook setup beginner
n8n cron schedule tutorial
n8n debugging tips
n8n data flow explained
n8n manual trigger vs webhook
```
