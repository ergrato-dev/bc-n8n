...
![Tipos de Triggers](01-tipos-triggers.svg)
...
![Expresión Cron](02-expresion-cron.svg)
...
![Flujo Webhook](03-flujo-webhook.svg)

**Uso en documentación:**

```markdown
![Flujo Webhook](../0-assets/03-flujo-webhook.svg)
```
...
![Debugging](04-debugging-workflow.svg)

**Uso en documentación:**

```markdown
![Debugging](../0-assets/04-debugging-workflow.svg)
```
...
![Proyecto](05-proyecto-recordatorios.svg)

**Uso en documentación:**

```markdown
![Proyecto](../0-assets/05-proyecto-recordatorios.svg)
```
